...
public abstract class LevelGenerator {
    ...
    public static void levelFive(GameEngine myEngine) throws IOException {
        ...
        */
        ...
        {
            if(i % 2 == 0 && i != 6)
                myEngine.myWalls.add(new Wall(9, i, myEngine.myTiles, "/Floor/uf_terrain/wall_crypt_8.png")); 
            else if (i != 6)
                myEngine.myWalls.add(new Wall(9, i, myEngine.myTiles, "/Floor/uf_terrain/wall_crypt_7.png")); 
        }
        myEngine.myWalls.add(new Wall(9, 5, myEngine.myTiles, "/Floor/uf_terrain/wall_crypt_16.png")); 
        
        // ...other Middle Wall
        for (int i = 10; i < myEngine.dungeonColumns - 1; i++)
        {
            if((i % 2 == 1 || i % 3 == 0) && i != 15)
                myEngine.myWalls.add(new Wall(i, 4, myEngine.myTiles, "/Floor/uf_terrain/wall_crypt_14.png")); 
            else if (i != 15)
                myEngine.myWalls.add(new Wall(i, 4, myEngine.myTiles, "/Floor/uf_terrain/wall_crypt_15.png")); 
        }
    ...
    public static void levelSix(GameEngine myEngine) throws IOException {
